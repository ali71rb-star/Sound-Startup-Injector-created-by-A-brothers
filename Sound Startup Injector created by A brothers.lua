...
-- 8. Code Generation and Injection Logic (Line-by-Line Safe Filtering with Self-Invasion Protection)
function generateInjectedCode()
    ...
    -- ایکسٹینشن کے فولڈر میں سے تمام پرانی ساؤنڈ فائلز کو پہلے صاف کریں گے
    ...
    -- لائن بائی لائن ریڈ کر کے پرانے بلاکس کو جڑ سے فلٹر اؤٹ کریں گے
    local lines = {}
    local skip = false
    ...
    local final_output_code = injected_logic_block .. "\n" .. original_code
